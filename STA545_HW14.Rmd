...
1(c) These two models will not always be the same as the linear model in 1(b) because they are search algorithms so there is a degree of stochasticity in their searches, where as the linear model will always yield the same result (assuming the same seed).
